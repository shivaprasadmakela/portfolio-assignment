    ...
    return (
        <>
            <section id='about'>
                ...
                <div className='smallscreen-color-bg'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="550" height="809" viewBox="0 0 720 629" fill="none">
                        ...
                        <image href="https://raw.githubusercontent.com/shivaprasadmakela/my-portfolio/master/public/profile-2.png" x="400" y="300" width="350" height="350" clip-path="url(#customClipPath)" />
                    </svg>
                </div>
